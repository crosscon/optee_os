...
#define OPTEE_SMC_OWNER_TRUSTED_OS	U(0x32)
#define OPTEE_SMC_OWNER_TRUSTED_OS_OPTEED U(0x3e)
#define OPTEE_SMC_OWNER_TRUSTED_OS_API	U(0x3f)

#else

#define OPTEE_SMC_OWNER_TRUSTED_OS	U(0x12)
#define OPTEE_SMC_OWNER_TRUSTED_OS_OPTEED U(0x1e)
#define OPTEE_SMC_OWNER_TRUSTED_OS_API	U(0x1f)
